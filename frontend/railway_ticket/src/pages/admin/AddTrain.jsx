  ...
  return (
    <>
      <div className="card mt-4">
        <div className="card-header text-center fs-5 bg-white">Add Train</div>
        <div className="card-body">
          <form onSubmit={(e) => submitForm(e)}>
            ...
            <button className="btn btn-primary col-md-12">Add Train</button>
          </form>
        </div>
      </div>
      <ToastContainer
